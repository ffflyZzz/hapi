export default {
  ...
  'session.action.archiveThread': 'Archive Thread',
  'session.action.restoreThread': 'Restore Thread',
  'session.action.codexTools': 'Codex Tools',
  'session.action.delete': 'Delete',
  'session.codexTools.title': 'Codex Tools',
  'session.codexTools.description': 'Inspect and manage the Codex thread behind "{name}".',
  'session.codexTools.currentThread': 'Current Thread',
  'session.codexTools.currentThreadUnavailable': 'Current thread details are unavailable.',
  'session.codexTools.threadName': 'Thread name',
  'session.codexTools.threadId': 'Thread ID',
  'session.codexTools.threadStatus': 'Status',
  'session.codexTools.threadCwd': 'Working directory',
  'session.codexTools.compactThread': 'Compact Thread',
  'session.codexTools.compactingThread': 'Compacting…',
  'session.codexTools.threadHistory': 'Thread History',
  'session.codexTools.activeThreads': 'Active threads',
  'session.codexTools.archivedThreads': 'Archived threads',
  'session.codexTools.noThreads': 'No threads found',
  'session.codexTools.skills': 'Skills',
  'session.codexTools.refreshSkills': 'Refresh Skills',
  'session.codexTools.noSkills': 'No skills discovered',
  'session.codexTools.noSkillDescription': 'No description provided',
  'session.codexTools.skillScope': 'Scope',
  'session.codexTools.skillPath': 'Path',
  'session.codexTools.skillDependencies': 'Dependencies',
  'session.codexTools.enabled': 'Enabled',
  'session.codexTools.disabled': 'Disabled',
  'session.codexTools.mcpServers': 'MCP Servers',
  'session.codexTools.noMcpServers': 'No MCP servers configured',
  'session.codexTools.reloadMcp': 'Reload MCP Config',
  'session.codexTools.reloadingMcp': 'Reloading…',
  'session.codexTools.mcpTools': 'Tools',
  'session.codexTools.mcpResources': 'Resources',
  'session.codexTools.config': 'Config',
  'session.codexTools.noConfig': 'No config snapshot available',
  'session.codexTools.configOrigins': 'Origins',
  'session.codexTools.writeConfigValue': 'Write Config Value',
  'session.codexTools.applyConfigBatch': 'Apply Config Batch',
  'session.codexTools.configKeyPath': 'Config Key Path',
  'session.codexTools.configValueJson': 'Config Value JSON',
  'session.codexTools.configMergeStrategy': 'Config Merge Strategy',
  'session.codexTools.configBatchJson': 'Batch Config Edits JSON',
  'session.codexTools.configKeyPathRequired': 'Config key path is required.',
  'session.codexTools.configInvalidJson': 'Config value must be valid JSON.',
  'session.codexTools.configInvalidBatchJson': 'Batch edits must be a valid JSON array.',
  'session.codexTools.configInvalidBatchShape': 'Each batch edit must include a non-empty keyPath.',
  'session.codexTools.configValueSaved': 'Config value saved.',
  'session.codexTools.configBatchSaved': 'Config batch applied.',
  'session.codexTools.configWriteFailed': 'Failed to write config value.',
  'session.codexTools.configBatchFailed': 'Failed to apply config batch.',
  'session.codexTools.unnamedThread': 'Unnamed thread',
  ...
  'dialog.archiveThread.title': 'Archive Thread',
  'dialog.archiveThread.description': 'Are you sure you want to archive the Codex thread for "{name}"? This will end the active session.',
  'dialog.archiveThread.confirm': 'Archive Thread',
  'dialog.archiveThread.confirming': 'Archiving thread…',
  'dialog.restoreThread.title': 'Restore Thread',
  'dialog.restoreThread.description': 'Restore the archived Codex thread for "{name}" back to the active thread list?',
  'dialog.restoreThread.confirm': 'Restore Thread',
  'dialog.restoreThread.confirming': 'Restoring thread…',
  'dialog.compact.title': 'Compact context',
  'dialog.compact.description': 'Send /compact to the current session now?',
  'dialog.compact.confirm': 'Compact Now',
  'dialog.compact.confirming': 'Compacting…',
  'composer.slashSkills.title': 'Insert skill',
  'composer.slashSkills.description': 'Choose a skill to insert into the composer as a $skill token.',
  'composer.slashSkills.searchLabel': 'Search skills',
  'composer.slashSkills.searchPlaceholder': 'Search skills…',
  'composer.slashSkills.loading': 'Loading skills…',
  'composer.slashSkills.empty': 'No skills available',
  'composer.slashSkills.error': 'Failed to load skills.',
